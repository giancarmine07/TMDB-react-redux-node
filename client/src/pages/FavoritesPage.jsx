...
/**
 * Pagina Preferiti
 * Mostra la lista dei film preferiti dell'utente
 */
const FavoritesPage = () => {
  ...
  // Carica i preferiti al montaggio del componente
  useEffect(() => {
    dispatch(fetchFavorites({}));
  }, [dispatch]);

  // Gestisce la rimozione di un film dai preferiti
